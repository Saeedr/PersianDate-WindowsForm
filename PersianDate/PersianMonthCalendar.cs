namespace FreeControls
{
    ...
    public partial class PersianMonthCalendar : Control
    {
        ...
        private Pen blackPen = new Pen(Brushes.Black, 1.30F);
        ...
        private Font weekFont = new System.Drawing.Font("B Yekan", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(178)));
        ...
        private void DarwWithArrangment(Graphics gr)
        {
            ...
            {
                iLeft -= 46;
                gr.DrawString(stDay, weekFont, Brushes.Brown, new Rectangle(iLeft, 2, iWidth, 16), sf);
            }
            // draw sep line
            ...
            foreach (CellInfo ci in cells) // Draw days
            {
                ...
                if (IsMarkDate(ci.Value))
                    gr.DrawRectangle(new Pen(markBrush, 1.40F), ci.Rectangle);
        ...
        private void yearNumericUpDown_Leave(object sender, EventArgs e)
        {
