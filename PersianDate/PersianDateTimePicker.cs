namespace FreeControls
{
    ...
    public partial class PersianDateTimePicker : Control
    {
        ...
        private Pen borderPen = new Pen(SystemColors.ButtonShadow, 1.25F);
        private SolidBrush selectedBrush = new SolidBrush(Color.Brown);
        ...
        private Font font = new System.Drawing.Font("B Yekan", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(178)));
        #endregion
                    ...
                    case Keys.Left:
                        {
                            ...
                            switch (selectedCommand)
                            {
                                case DatePartTypes.Minute:
                                    {
                                        selectedCommand = DatePartTypes.Hour;
                                        if (this.persianValue.Minute > 0 && this.persianValue.Minute < 60)
                                            this.Value = new PersianDate(persianValue.Year, persianValue.Month, persianValue.Day, persianValue.Hour, persianValue.Minute, persianValue.Second);
                                    }
                                    break;
                                case DatePartTypes.Hour:
                                    {
                                        selectedCommand = DatePartTypes.Day;
                                        if (this.persianValue.Hour > 0 && this.persianValue.Hour < 25)
                                            this.Value = new PersianDate(persianValue.Year, persianValue.Month, persianValue.Day, persianValue.Hour, persianValue.Minute, persianValue.Second);
                                ...
                                case DatePartTypes.Day:
                                    {
                                        selectedCommand = DatePartTypes.Month;
                                        if (this.persianValue.Month > 00 && this.persianValue.Month < 31)
                                            this.Value = new PersianDate(persianValue.Year, persianValue.Month, persianValue.Day, persianValue.Hour, persianValue.Minute, persianValue.Second);
                                ...
                                case DatePartTypes.Month:
                                    {
                                        selectedCommand = DatePartTypes.Year;
                                        if (this.persianValue.Month > 00 && this.persianValue.Month < 13)
                                            this.Value = new PersianDate(persianValue.Year, persianValue.Month, persianValue.Day, persianValue.Hour, persianValue.Minute, persianValue.Second);
                                ...
                                case DatePartTypes.Year:
                                    {
                                        if (!showTime)
                                            ...
                                            selectedCommand = DatePartTypes.Minute;
                                        if (this.persianValue.Year >= 1300 && this.persianValue.Year <= 1500)
                                            this.Value = new PersianDate(persianValue.Year, persianValue.Month, persianValue.Day, persianValue.Hour, persianValue.Minute, persianValue.Second);
        ...
        private void PersianDateTimePicker_KeyDown(object sender, KeyEventArgs e)
        {
